...
if ( $the_query->have_posts() ) :
    ...
    while ( $the_query->have_posts() ) : $the_query->the_post();
        ...
        $html .= get_avatar( get_post_meta( get_the_ID() , "_billing_email",true ), 100 );
        $html .= '</div>';
        ...
        if($contributor_show == 'yes'):
            ...
            $html .= '<h3 class="color-navy-blue semi-bold">'.get_post_meta( get_the_ID() , "_billing_first_name",true ).' '.get_post_meta( get_the_ID() , "_billing_last_name",true ).'</h3>';
        endif;
